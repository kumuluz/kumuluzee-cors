# Contributing to KumuluzEE CORS

♥ [KumuluzEE CORS](https://github.com/kumuluz/kumuluzee-cors) and want to get involved?
...
**[File a bug report](https://github.com/kumuluz/kumuluzee-cors/issues/)**
...
1. [Fork](http://help.github.com/fork-a-repo/) the project, clone your fork,
   ...
   git clone https://github.com/<your-username>/kumuluzee-cors.git
   # Navigate to the newly cloned directory
   cd kumuluzee-cors
   # Assigns the original repo to a remote called "upstream"
   git remote add upstream https://github.com/kumuluz/kumuluzee-cors.git
   ```
