...
Configuration in config takes priority over values defined in CrossOrigin annotation. Annotation's *name* parameter must be provided and it needs to match the config key.
