...
public class CrossOriginAnnotationProcessor extends AbstractProcessor {

    private static final Logger LOG = Logger.getLogger(CrossOriginAnnotationProcessor.class.getName());
